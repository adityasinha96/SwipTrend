...
<div class="card">
    <div class="card-header">
        {{ trans('cruds.cataloguData.title_singular') }} {{ trans('global.list') }}
    </div>

    <div class="card-body">
        <table class=" table table-bordered table-striped table-hover ajaxTable datatable datatable-CataloguData">
            <thead>
                <tr>
                    <th width="10">
...
@can('catalogu_data_delete')
  ...
  let deleteButton = {
    ...
    url: "{{ route('admin.catalogu-datas.massDestroy') }}",
