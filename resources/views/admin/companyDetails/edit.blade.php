...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.companyDetail.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.company-details.update", [$companyDetail->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                <label class="required" for="company_name">{{ trans('cruds.companyDetail.fields.company_name') }}</label>
                <textarea class="form-control {{ $errors->has('company_name') ? 'is-invalid' : '' }}" name="company_name" id="company_name" required>{{ old('company_name', $companyDetail->company_name) }}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('gst_number') ? 'is-invalid' : '' }}" type="text" name="gst_number" id="gst_number" value="{{ old('gst_number', $companyDetail->gst_number) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('company_phone_number') ? 'is-invalid' : '' }}" type="text" name="company_phone_number" id="company_phone_number" value="{{ old('company_phone_number', $companyDetail->company_phone_number) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('other_phone_number') ? 'is-invalid' : '' }}" type="text" name="other_phone_number" id="other_phone_number" value="{{ old('other_phone_number', $companyDetail->other_phone_number) }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('google_map_link') ? 'is-invalid' : '' }}" name="google_map_link" id="google_map_link" required>{{ old('google_map_link', $companyDetail->google_map_link) }}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('email') ? 'is-invalid' : '' }}" type="email" name="email" id="email" value="{{ old('email', $companyDetail->email) }}" required>
                @if($errors->has('email'))
                    <div class="invalid-feedback">
                        {{ $errors->first('email') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('other_email') ? 'is-invalid' : '' }}" type="text" name="other_email" id="other_email" value="{{ old('other_email', $companyDetail->other_email) }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('office_address') ? 'is-invalid' : '' }}" name="office_address" id="office_address" required>{{ old('office_address', $companyDetail->office_address) }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('company_facebook_link') ? 'is-invalid' : '' }}" name="company_facebook_link" id="company_facebook_link">{{ old('company_facebook_link', $companyDetail->company_facebook_link) }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('comapnay_instagram_link') ? 'is-invalid' : '' }}" name="comapnay_instagram_link" id="comapnay_instagram_link">{{ old('comapnay_instagram_link', $companyDetail->comapnay_instagram_link) }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('company_linkedin_link') ? 'is-invalid' : '' }}" name="company_linkedin_link" id="company_linkedin_link">{{ old('company_linkedin_link', $companyDetail->company_linkedin_link) }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('company_youtube_link') ? 'is-invalid' : '' }}" name="company_youtube_link" id="company_youtube_link">{{ old('company_youtube_link', $companyDetail->company_youtube_link) }}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('company_x_link') ? 'is-invalid' : '' }}" type="text" name="company_x_link" id="company_x_link" value="{{ old('company_x_link', $companyDetail->company_x_link) }}">
