...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.quickServiceRequest.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.quick-service-requests.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('city_area') ? 'is-invalid' : '' }}" type="text" name="city_area" id="city_area" value="{{ old('city_area', '') }}" required>
